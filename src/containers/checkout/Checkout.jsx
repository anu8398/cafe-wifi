    ...
    render() {
        ...
        return (
            ...
            <Col md="8" className="m-auto text-center">
                ...
                <h4 className="lead text-muted font-italic my-4">While we're making your products ready, you can star this <a href="https://github.com/apshada" target="_blank">project</a> on Github.</h4>
            </Col>
